...
class ElasticClient
{
    ...
    public function testConnection(){
        return $this->curl->sendGetRequest($this->getBaseUrl());
    }
    ...
    public function saveItem(IndexInterface $index, array $data, $ingest = false){
        ...
        $data = $this->curl->sendPutRequest($url,$data,$this->getHeaders());
 ...
 */
    public function createIndex(IndexInterface $index){
        ...
        $data = $this->curl->sendPutRequest($url,$settings,$this->getHeaders());
    ...
    public function createMapping(IndexInterface $index){
        ...
        $data = $this->curl->sendPutRequest($url,$properties,$this->getHeaders());
    ...
    public function deleteIndex(IndexInterface $index){
        $name = $index->getIndexName();
        $url = $this->getBaseUrl() . '/' . $name;
        $this->curl->sendDeleteRequest($url);
    }
